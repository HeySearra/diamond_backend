...
class ReadAuth(models.Model):
    user = models.ManyToManyField(to='user.User', related_name='readable_doc', on_delete=models.CASCADE)
...
class CommentAuth(models.Model):
    user = models.ManyToManyField(to='user.User', related_name='commentable_doc', on_delete=models.CASCADE)
...
class WriteAuth(models.Model):
    user = models.ManyToManyField(to='user.User', related_name='writeable_doc', on_delete=models.CASCADE)
